...
namespace EStore.Auth
{
    partial class LoginControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.radPictureBox1.Location = new System.Drawing.Point(26, 16);
            this.radPictureBox1.Margin = new System.Windows.Forms.Padding(0, 3, 0, 3);
            ...
            this.radPictureBox1.Size = new System.Drawing.Size(20, 20);
            ...
            // txtEmail
            // 
            this.txtEmail.Location = new System.Drawing.Point(46, 15);
            ...
            this.radPictureBox2.Location = new System.Drawing.Point(26, 56);
            this.radPictureBox2.Margin = new System.Windows.Forms.Padding(0, 3, 0, 3);
            ...
            this.radPictureBox2.Size = new System.Drawing.Size(20, 20);
            this.radPictureBox2.TabIndex = 2;
            ((Telerik.WinControls.UI.RadPictureBoxElement)(this.radPictureBox2.GetChildAt(0))).Image = global::EStore.Properties.Resources.user__2_;
            ...
            ((Telerik.WinControls.UI.PictureBoxCanvasElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(0))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.PictureBoxHorizontalPanelElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(1))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(1).GetChildAt(0))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(1).GetChildAt(1))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(1).GetChildAt(2))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.PictureBoxHorizontalPanelElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(2))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(2).GetChildAt(0))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(2).GetChildAt(1))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(2).GetChildAt(2))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.PictureBoxVerticalPanelElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(3))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(3).GetChildAt(0))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(3).GetChildAt(1))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(3).GetChildAt(2))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.PictureBoxVerticalPanelElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(4))).ShadowDepth = 0;
            ((Telerik.WinControls.UI.StackLayoutElementLite)(this.radPictureBox2.GetChildAt(0).GetChildAt(4).GetChildAt(0))).ShadowDepth = 0;
            ((Telerik.WinControls.Layouts.StackLayoutPanel)(this.radPictureBox2.GetChildAt(0).GetChildAt(5))).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
            ((Telerik.WinControls.UI.LightVisualElement)(this.radPictureBox2.GetChildAt(0).GetChildAt(5).GetChildAt(0))).SvgImageXml = resources.GetString("resource.SvgImageXml");
            ...
            // txtPassword
            // 
            this.txtPassword.Location = new System.Drawing.Point(46, 55);
