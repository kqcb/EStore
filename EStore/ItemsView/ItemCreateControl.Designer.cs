...
namespace EStore_Temp.ItemsView
{
    partial class ItemCreateControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((Telerik.WinControls.Primitives.TextPrimitive)(this.btnCreate.GetChildAt(0).GetChildAt(1).GetChildAt(1))).ForeColor = System.Drawing.Color.White;
            ((Telerik.WinControls.Primitives.TextPrimitive)(this.btnCreate.GetChildAt(0).GetChildAt(1).GetChildAt(1))).Alignment = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // btnCancel
            // 
